        ...
        <div class="col-lg-12">
          <div class="box box-primary">
           ...
           <div style="margin:20px">
              <form method="post" action="<?php echo SITE_URL('user/dashboard/project_saving'); ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="url" placeholder="HTTPS://..." required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="category" placeholder="Categories" required>
                  </div>
                </div>
                ...
                <div class="text-right mt-4" style="margin-right:150px">
                  <input type="submit" name="submit" value="Add project" class="btn" style="border-radius:20px; background:#8ab5fc; color:white; margin:20px;">
                </div>
